package com.technoapps.technovpn.activity;
...
import com.technoapps.technovpn.BuildConfig;
import com.technoapps.technovpn.R;
import com.technoapps.technovpn.model.Server;
import com.technoapps.technovpn.util.PropertiesService;
import com.technoapps.technovpn.util.Stopwatch;
import com.technoapps.technovpn.util.TotalTraffic;
...
import static com.technoapps.technovpn.Constant.UpgradePro;
...
public class VPNInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String totalIn = String.format(getResources().getString(R.string.traffic_in),
                TotalTraffic.getTotalTraffic(getApplicationContext()).get(0));
        ...
        String totalOut = String.format(getResources().getString(R.string.traffic_out),
                TotalTraffic.getTotalTraffic(getApplicationContext()).get(1));
...
//procheck2();
    ...
    public void procheck2()
    {
        ...
        if(strPref)
        {
            ...
            InterstitialAd.load(VPNInfoActivity.this,getString(R.string.interstitial_ad_unit), adRequest,
...
//                            mInterstitialAd = interstitialAd;
                            interstitialAd.show(VPNInfoActivity.this);
//                            Log.i(TAG, "onAdLoaded");
                        ...
                        public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                            // Handle the error
//                            errorLog.d(TAG, loadAdError.toString());
