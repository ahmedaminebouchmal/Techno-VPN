...
import com.technoapps.technovpn.adapter.HomeListAdapter;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_speedtest) {
            ...
            Uri uri = Uri.parse("https://play.google.com/store/apps/dev?id=7811177590990356082");
            Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
            try {
                startActivity(goToMarket);
            } catch (ActivityNotFoundException e) {
                startActivity(new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://play.google.com/store/apps/dev?id=7811177590990356082")));
            }
